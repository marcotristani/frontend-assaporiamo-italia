...
function TuttiVini() {
  ...
  if (categoriaSlug) {
    fineEndpointVini = `api/vini/categoria/${categoriaSlug}${stringaQueryRimanenti}`;
  } else {
    fineEndpointVini = `api/vini/all${stringaQueryRimanenti}`;
  }

  useEffect(() => {
    fetchResponse(fineEndpointVini, setVini);
    setTipoProdottoCorrente("vino");
  }, [fineEndpointVini]);
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-orange-100/60 pb-6">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Scopri i migliori vini della penisola
            </p>
          </div>
